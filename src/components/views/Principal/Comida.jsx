      ...
      <Card className="h-100">
        <div className="row g-0 h-100">
          <div className="col-md-5 ">
            <Image
              src={producto.imagen}
              className="imagenCard w-100 h-100 rounded-start object-fit-cover h-100"
              alt={producto.nom}
            ></Image>
          </div>
          <div className="col-md-7 cuerpoInfoCardProducto">
            <div className="card-body cuerpoInfoCardProductoInterno">
              <h5 className="card-title mb-auto">{producto.nombreProducto}</h5>
              <p className="card-text detalleProductoInicio mb-auto">
                {producto.detalle}
              </p>
              <h5 className="card-title mb-auto" id="precio-comida">$ {producto.precio}</h5>
              <Link to={`/detalleProducto/${producto._id}`} id="btn-verdetalle" className="btn w-100 mb-2 mt-auto" >Ver detalle</Link>
