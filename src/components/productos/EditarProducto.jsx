    ...
    return (
      ...
      <Form onSubmit={handleSubmit()}>
        ...
        <Form.Group className="mb-3" controlId="formImagen">
            ...
            <Form.Control type="text" placeholder="Ej: https://cloudfront-us-east-1.images.arcpublishing.com/elespectador/KRMQHXYYBFBI5KRDXUYY5AXH2A.jpg" 
            {...register("imagen",{
                required: 'La URL de la Imagen es obligatoria y debe terminar con .jpg/.png/.svg/.jpeg',
                minLength:{
                  value: 1,
                  message: 'La URL de la Imagen Imagen del Producto debe contener como mínimo 1 carácter'
                },
                pattern:{
                  value: /^(http(s?):)([/|.|\w|\s|-])*\.(?:jpg|jpeg|png|svg)$/,
                  message: 'La URL de la Imagen debe terminar con .jpg/.png/.svg/.jpeg'
                }
              })}/>
              <Form.Text className="text-danger">
        ...
        <Form.Group className="mb-3" controlId="formDetalle">
            ...
            {...register('detalle',{
                ...
                minLength:{
                  value: 8,
                  message: 'El detalle del Producto debe contener como mínimo 8 carácteres debe empezar con la primera letra mayúscula'
                },
                maxLength:{
                  value: 150,
                  message: 'El detalle del Producto debe contener como máximo 150 carácteres'
                },
                pattern:{
                  value: /^(?=.*[A-Z])[A-Za-z0-9:,.\s]{7,199}$/,
                  message: 'El detalle del producto debe comenzar con mayúscula y debe contener como mínimo 8 carácteres y como máximo 150 carácteres (puede usar letras, números y signos de puntuación)'
                }
              })}
            ></Form.Control>
            <Form.Text className="text-danger">
        ...
        <Button type="submit" className="btn btn-warning mb-2">Editar Producto</Button>
      </Form>
    </Container>
    );
};
